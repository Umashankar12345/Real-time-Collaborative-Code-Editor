    ...
    <div className="flex justify-center items-center min-h-screen w-full relative overflow-hidden bg-gradient-to-br from-[#0B0F19] via-[#1A0B2E] to-[#0F172A]">
      ...
      <div className="w-full max-w-[440px] p-10 rounded-2xl relative z-10 animate-fade-in mx-4 
        ...
        <div className="flex flex-col gap-3">
          <button 
            type="button"
            onClick={() => window.location.href = 'http://localhost:5000/api/auth/github/login'}
            className="relative w-full bg-[#18181B]/80 hover:bg-[#27272A]/90 border border-[#8B5CF6]/20 hover:border-[#8B5CF6]/50 hover:shadow-[0_0_15px_rgba(139,92,246,0.2)] text-[#E4E4E7] py-3.5 rounded-xl flex items-center justify-center gap-3 transition-all duration-300"
          >
          ...
          <button 
            ...
            className="relative w-full bg-[#18181B]/80 hover:bg-[#27272A]/90 border border-[#00A8FF]/20 hover:border-[#00A8FF]/50 hover:shadow-[0_0_15px_rgba(0,168,255,0.2)] text-[#E4E4E7] py-3.5 rounded-xl flex items-center justify-center gap-3 transition-all duration-300"
          >
